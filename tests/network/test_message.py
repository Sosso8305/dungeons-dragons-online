...
from dungeonX.network.message import Message,extract, read_id, read_type, read_position, read_attributes, read_int, read_IP
...
#     assert message.create_message() == "wlc01"+zeros+n1+"R00000000"+zeros+n2+"M00010002"+zeros+n3+"F00030004" 
#     assert message1.create_message(ID = int(n1)) == "pos01"+zeros+n1+"00000000" 
#     assert message2.create_message(ID = int(n1), IDenemy = int(n))  == "hps01"+zeros+n1+"100"+zerosm+n+"100"
#     assert message3.create_message() == "con000000121.0.0.708000" 
#     assert message4.create_message() == "new01R00000000M00010002F00030004"
#     assert message5.create_message(ID = int(n1), IDItem= swordItem.id) == "ite01"+zeros+n1+"0"+str(swordItem.id)
...
#     assert liste == ["01",[zeros+n1,"R","0000","0000"],[zeros+n2,"M","0001","0002"],[zeros+n3,"F","0003","0004"]]
#     assert liste1 == ["01",zeros+n1,"0000","0000"]
#     assert liste2 == ["01",zeros+n1,"100",zerosm+n,"100"]
#     assert liste3 == ["000000121.0.0.7","08000"]
#     assert liste4 == ["01",["R","0000","0000"],["M","0001","0002"],["F","0003","0004"]]
#     assert liste5 == ["01",zeros+n1,"0"+str(swordItem.id)]
